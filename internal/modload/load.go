...
import (
	...
	"moduleList/internal/imports"
	"moduleList/internal/modfetch"
	"moduleList/internal/modindex"
	"moduleList/internal/mvs"
	"moduleList/internal/par"
	"moduleList/internal/search"
	"moduleList/internal/str"
	"os"
	"path"
	pathpkg "path"
	"path/filepath"
...
func ImportFromFiles(ctx context.Context, gofiles []string) {
	...
	tags := imports.Tags()
	scanFiles, testImports, err := imports.ScanFiles(gofiles, tags)
	if err != nil {
		log.Fatal(err)
	}
